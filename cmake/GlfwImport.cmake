...
# If building with a GTK platform backend, skip including GLFW entirely
if(DEFINED USE_GTK_PLATFORM AND USE_GTK_PLATFORM)
    message(STATUS "GlfwImport: Skipping GLFW import because USE_GTK_PLATFORM=ON")
else()
